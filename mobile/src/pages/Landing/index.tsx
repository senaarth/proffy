...
function Landing() {
    ...
    function handleNavigateToGiveStudy() {
        navigate('Study');
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.buttonsContainer}>
                <RectButton onPress={handleNavigateToGiveStudy} style={[styles.button, styles.buttonPrimary]}>
            ...
            <Text style={styles.totalConnections}>
                Total de 265 conexões já realizadas. {' '}
